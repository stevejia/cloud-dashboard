...
<script>
import translateConfig from "./sharp.js";
export default {
  props: {
    theme: String
  },
  ...
  methods: {
    ...
    initStyle(bool) {
      ...
      this.leftArrow = {
        ...
        borderWidth: 5 + this.baisicConfig["线条粗细"].value + "px",
        marginLeft: -5 - this.baisicConfig["线条粗细"].value + "px"
      };
      this.rightArrow = {
        display:
        ...
        borderWidth: 5 + this.baisicConfig["线条粗细"].value + "px",
        marginRight: -5 - this.baisicConfig["线条粗细"].value + "px"
      };
      if (!bool) {
        this.$parent.initStyle(null, null, this.baisicConfig["旋转角度"].value);
      }
    }
  },
  data() {
