<template>
  <div class="layout">
    <div class="MainBody">
      <headers v-show="isShare" ref="headers" class="headers"></headers>
      <tabMenu v-show="isShare" ref="tabMenus" class="tabMenus"></tabMenu>
      <div class="main" :style="{ top: isShare ? mainTop + 'px' : '' }">
        <lefters
          v-show="isShare"
          ref="lefters"
          class="lefters"
...
export default {
  ...
  methods: {
    ...
    toggLeft(status) {
      ...
      this.$children[3].initStyle(true, this.mainLeft);
    },
    themeChange(theme) {
      this.theme = theme;
