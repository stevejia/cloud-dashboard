...
import progressList from "@/component/sub/progressList.vue"; // 进度列表
import canvasCurve from "@/component/sub/canvasCurve.vue"; // 画布曲线
...
// 3d
import Cube from "@/component/3d/cube.vue"; //冷冻站
