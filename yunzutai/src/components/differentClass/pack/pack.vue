...
<div class="comps">
    <template v-for="(item, title) in config">
        <template v-if="item.type === 'input'">
            <packInput :title="title" :config="item" :key="title" :onChange="changes"></packInput>
        </template>
        <template v-else-if="item.type === 'select'">
            <packSelect :title="title" :config="item" :key="title" :onChange="changes"></packSelect>
        </template>
        <template v-else-if="item.type === 'resetStyle'">
            <packResetStyle :title="title" :config="item" :key="title" :onChange="changes"></packResetStyle>
        </template>
        <template v-else-if="item.type === 'fontStyle'">
            <packFontStyle :title="title" :config="item" :key="title" :onChange="changes"></packFontStyle>
        </template>
        <template v-else-if="item.type === 'inputFontStyle'">
            <packInputFontStyle :title="title" :config="item" :key="title" :onChange="changes"></packInputFontStyle>
        </template>
        <template v-else-if="item.type === 'shadowStyle'">
            <packShadowStyle :title="title" :config="item" :key="title" :onChange="changes"></packShadowStyle>
        </template>
        <template v-else-if="item.type === 'logo'">
            <packLogo :title="title" :config="item" :key="title" :onChange="changes"></packLogo>
        </template>
        <template v-else-if="item.type === 'color-select'">
            <packColorSelect :title="title" :config="item" :key="title" :onChange="changes"></packColorSelect>
        </template>
        <template v-else-if="item.type === 'checkbox'">
            <packCheckbox :title="title" :config="item" :key="title" :onChange="changes"></packCheckbox>
        </template>
        <template v-else-if="item.type === 'sky'">
            <packSky :title="title" :config="item" :key="title" :onChange="changes"></packSky>
        </template>
        <template v-else-if="item.type === 'linear-gradient'">
            <packLinearGradient :title="title" :config="item" :key="title" :onChange="changes"></packLinearGradient>
        </template>
        <template v-else-if="item.type === 'widthHeight'">
            <packWidthHeight :title="title" :config="item" :key="title" :onChange="changes"></packWidthHeight>
        </template>
        <template v-else-if="item.type === 'slider'">
            <packSlider :title="title" :config="item" :key="title" :onChange="changes"></packSlider>
        </template>
        <template v-else-if="item.type === 'textarea'">
            <packTextarea :title="title" :config="item" :key="title" :onChange="changes"></packTextarea>
        </template>
        <template v-else-if="item.type === 'font'">
            <packFont :title="title" :config="item" :key="title" :onChange="changes"></packFont>
        </template>
        <template v-else-if="item.type === 'font-align'">
            <packFontAlign :title="title" :config="item" :key="title" :onChange="changes"></packFontAlign>
        </template>
        <template v-else-if="item.type === 'slider-gradient'">
            <packSliderGradient :title="title" :config="item" :key="title" :onChange="changes"></packSliderGradient>
        </template>
        <template v-else-if="item.type === 'explain'">
            <packExplain :title="title" :config="item" :key="title" :onChange="changes"></packExplain>
        </template>
        <template v-else-if="item.type === 'eventOpacity'">
            <packEventOpacity :title="title" :config="item" :key="title" :onChange="changes"></packEventOpacity>
        </template>
        <template v-else-if="item.type === 'eventVisible'">
            <packEventVisible :title="title" :config="item" :key="title" :onChange="changes"></packEventVisible>
        </template>
        <template v-else-if="item.type === 'eventColor'">
            <packEventColor :title="title" :config="item" :key="title" :onChange="changes"></packEventColor>
        </template>
        <template v-else-if="item.type === 'eventColorChange'">
            <packEventColorChange :title="title" :config="item" :key="title" :onChange="changes"></packEventColorChange>
        </template>
        <template v-else-if="item.type === 'event'">
            <packEvent :title="title" :config="item" :key="title" :onChange="changes"></packEvent>
        </template>
        <template v-else-if="item.type === 'line'">
            <packLine :title="title" :config="item" :key="title" :onChange="changes"></packLine>
        </template>
        <template v-else-if="item.type === 'deciaml'">
            <packDeciaml :title="title" :config="item" :key="title" :onChange="changes"></packDeciaml>
        </template>
        <template v-else-if="item.type === 'mul-checkbox'">
            <packMulCheckbox :title="title" :config="item" :key="title" :onChange="changes"></packMulCheckbox>
        </template>
        <template v-else-if="item.type === 'upload-image'">
            <packUploadImage :title="title" :config="item" :key="title" :onChange="changes"></packUploadImage>
        </template>
        <template v-else-if="item.type === 'degree'">
            <packDegree :title="title" :config="item" :key="title" :onChange="changes"></packDegree>
        </template>
        <template v-else-if="item.type === 'iconCheckbox'">
            <packIconCheckbox :title="title" :config="item" :key="title" :onChange="changes"></packIconCheckbox>
        </template>
        <template v-else-if="item.type === 'container'">
            <packContainer :title="title" :config="item" :key="title" :onChange="changes"></packContainer>
        </template>
        <template v-else-if="item.type === 'dateTypeCheckbox'">
            <packDateTypeCheckbox :title="title" :config="item" :key="title" :onChange="changes"></packDateTypeCheckbox>
        </template>
        <template v-else-if="item.type === 'eventMap'">
            <packEventMap :title="title" :config="item" :key="title" :onChange="changes"></packEventMap>
        </template>
        <template v-else-if="item.type === 'seriesData'">
            <packSeriesData :title="title" :config="item" :key="title" :onChange="changes"></packSeriesData>
        </template>
        <template v-else-if="item.type === 'fontThree'">
            <packFontThree :title="title" :config="item" :key="title" :onChange="changes"></packFontThree>
        </template>
        <template v-else-if="item.type === 'fontSelect'">
            <packFontSelect :title="title" :config="item" :key="title" :onChange="changes"></packFontSelect>
        </template>
        <template v-else-if="item.type === 'treeConfig'">
            <packTreeConfig :title="title" :config="item" :key="title" :onChange="changes"></packTreeConfig>
        </template>
        <template v-else-if="item.type === 'dependDateSelect'">
            <packDependDateSelect :title="title" :config="item" :key="title" :onChange="changes"></packDependDateSelect>
        </template>
        <template v-else-if="item.type === 'dependtree'">
            <packDependtree :title="title" :config="item" :key="title" :onChange="changes"></packDependtree>
        </template>
        <template v-else-if="item.type === 'dateType'">
            <packDateType :title="title" :config="item" :key="title" :onChange="changes"></packDateType>
        </template>
        <template v-else-if="item.type === 'pieNestedSeries'">
            <packPieNestedSeries :title="title" :config="item" :key="title" :onChange="changes"></packPieNestedSeries>
        </template>
        <template v-else-if="item.type === 'coordinate'">
            <packCoordinate :title="title" :config="item" :key="title" :onChange="changes"></packCoordinate>
        </template>
        <template v-else-if="item.type === 'composeSeriesData'">
            <packComposeSeriesData :title="title" :config="item" :key="title" :onChange="changes"></packComposeSeriesData>
        </template>
        <template v-else-if="item.type === 'composeSeriesData2'">
            <packComposeSeriesData2 :title="title" :config="item" :key="title" :onChange="changes"></packComposeSeriesData2>
        </template>
        <template v-else-if="item.type === 'composeSeriesData3'">
            <packComposeSeriesData3 :title="title" :config="item" :key="title" :onChange="changes"></packComposeSeriesData3>
        </template>
        <template v-else-if="item.type === 'mulInput'">
            <packMulInput :title="title" :config="item" :key="title" :onChange="changes"></packMulInput>
        </template>
        <template v-else-if="item.type === 'checkboxFold'">
            <packCheckboxFold :title="title" :config="item" :key="title" :onChange="changes"></packCheckboxFold>
        </template>
        <template v-else-if="item.type === 'containerSelect'">
            <packContainerSelect :title="title" :config="item" :key="title" :onChange="changes"></packContainerSelect>
        </template>
        <template v-else-if="item.type === 'btnRotate'">
            <packBtnRotate :title="title" :config="item" :key="title" :onChange="changes"></packBtnRotate>
        </template>
        <template v-else-if="item.type === 'fontAbleSet'">
            <packFontAbleSet :title="title" :config="item" :key="title" :onChange="changes"></packFontAbleSet>
        </template>
        <template v-else-if="item.type === 'fontThrees'">
            <packFontThrees :title="title" :config="item" :key="title" :onChange="changes"></packFontThrees>
        </template>
        <template v-else-if="item.type === 'inputNumber'">
            <packInputNumber :title="title" :config="item" :key="title" :onChange="changes"></packInputNumber>
        </template>
        <template v-else-if="item.type === 'dataTree'">
            <packDataTree :title="title" :config="item" :key="title" :onChange="changes"></packDataTree>
        </template>
        <template v-else-if="item.type === 'numRange'">
            <packNumRange :title="title" :config="item" :key="title" :onChange="changes"></packNumRange>
        </template>
        <template v-else-if="item.type === 'numRanges'">
            <packNumRanges :title="title" :config="item" :key="title" :onChange="changes"></packNumRanges>
        </template>
        <template v-else-if="item.type === 'fontFour'">
            <packFontFour :title="title" :config="item" :key="title" :onChange="changes"></packFontFour>
        </template>
        <template v-else-if="item.type === 'energy'">
            <packEnergy :title="title" :config="item" :key="title" :onChange="changes"></packEnergy>
        </template>
        ...
        <template v-else-if="item.type === 'zoom'">
            <packZoom :title="title" :config="item" :key="title" :onChange="changes"></packZoom>
        </template>
        <template v-else-if="item.type === 'writeable'">
            <packWriteable :title="title" :config="item" :key="title" :onChange="changes"></packWriteable>
        </template>
        <template v-else-if="item.type === 'eventBtn'">
            <packEventBtn :title="title" :config="item" :key="title" :onChange="changes"></packEventBtn>
        </template>
        <template v-else-if="item.type === 'modeToggle'">
            <packModeToggle :title="title" :config="item" :key="title" :onChange="changes"></packModeToggle>
        </template>
        <template v-else-if="item.type === 'pieSelectDate'">
            <packPieSelectDate :title="title" :config="item" :key="title" :onChange="changes"></packPieSelectDate>
        </template>
        <template v-else-if="item.type === 'fontResponse'">
            <packFontResponse :title="title" :config="item" :key="title" :onChange="changes"></packFontResponse>
        </template>
        <template v-else-if="item.type === 'dataTreeLinkage'">
            <packDataTreeLinkage :title="title" :config="item" :key="title" :onChange="changes"></packDataTreeLinkage>
        </template>
        <template v-else-if="item.type === 'twoInput'">
            <packTwoInput :title="title" :config="item" :key="title" :onChange="changes"></packTwoInput>
        </template>
        <template v-else-if="item.type === 'color-select-row'">
            <packColorSelectRow :title="title" :config="item" :key="title" :onChange="changes"></packColorSelectRow>
        </template>
        <template v-else-if="item.type === 'eventMapNumber'">
            <packEventMapNumber :title="title" :config="item" :key="title" :onChange="changes"></packEventMapNumber>
        </template>
        <template v-else-if="item.type === 'mode-background'">
            <packModeBackground :title="title" :config="item" :key="title" :onChange="changes"></packModeBackground>
        </template>
        <template v-else-if="item.type === 'text'">
            <packText :title="title" :config="item" :key="title" :onChange="changes"></packText>
        </template>
        <template v-else-if="item.type === 'progressListConfig'">
            <packProgressList :title="title" :config="item" :key="title" :onChange="changes"></packProgressList>
        </template>
        <template v-else-if="item.type === 'coordinateMap'">
            <packCoordinateMap :title="title" :config="item" :key="title" :onChange="changes"></packCoordinateMap>
        </template>
        <template v-else-if="item.type === 'position3D'">
            <packPosition3D :title="title" :config="item" :key="title" :onChange="changes"></packPosition3D>
        </template>
    </template>
</div>
</template>
...
const packPosition3D = () => import("./position3D.vue");
