<template>
<div :class="locked ? 'locked rightTab' : 'rightTab'" :style="{ width: `${showPropertyMenu ? 300 : 0}px` }">
    <span @mousedown.stop="toggleMenu" :class="[
        'iconfont',
    ...
    <div class="body">
        <div class="component" v-show="showPropertyMenu">
            ...
            <comp3D ref="type8" v-show="currentClass === 5"></comp3D>
            <compSystem ref="type6" v-show="currentClass === 6"></compSystem>
            <compCustomSymbol ref="type7" v-show="currentClass === 7"></compCustomSymbol>
    ...
    <div class="menu" @mousedown="clearVms">
        ...
        " :class="currentClass === index ? 'active menuItem' : 'menuItem'" v-for="(item, index) in list" :key="item.name + index">
            <div>
        ...
        <div @mousedown.stop="deal(item)" class="menuItem" v-for="(item, index) in otherList" :key="item.name + index">
            <div>
                <span :class="'iconfont ' + item.icon"></span>
            </div>
            <div class="title">{{ item.name }}</div>
...
import comp3D from "./differentClass/3d.vue";
                ...
                case "保存":
                    ...
                    config = {
                        ...
                        routeConfig: {
                            ...
                            currentSelectChildrenRoute: left.$refs.routes.currentSelectChildrenRoute,
